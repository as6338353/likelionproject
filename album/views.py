...
def album(request):
    ...
    return render(request, "album_list.html", {'rsAlbum': rsAlbum})
...
def album_insert(request):
    ...
    fs = FileSystemStorge(location='static/album/photos')
...
def album_edit(request):
    ...
    return render(request, "album_edit.html", {'rsDetail': rsDetail, 'a_no':ano})
